...
class LengthValidator:
    ...
    def __call__(self, *args, **kwargs):
        return self.min_length <= args[0] <= self.max_length
...
class CharsValidator:
    ...
    def __call__(self, *args, **kwargs):
        return all([i in args[0] for i in self.chars])


lv = LengthValidator(10, 50)  # min_length - минимально допустимая длина; max_length - максимально допустимая длина
cv = CharsValidator(string.ascii_lowercase)  # chars - строка из допустимых символов
